var Hammer = cc.Sprite.extend({
    ...
    update:function (dt) {
        ...
        var xp = GAME.KEEPER.XPOSITION +  this._xVelocity * this._time;
        var yp = GAME.KEEPER.YPOSITION +  this._yVelocity * this._time - 0.5*this._gravity*Math.pow(this._time,2)

        yp > (GAME.KEEPER.YPOSITION - 10)? this.setPosition(xp, yp) : this.destroy();
    },
...
Hammer.createHammer = function(xVelocity, yVelocity) {	
	...
	GAME.CONTAINER.HAMMERS.push(hammer);
    return hammer;
};
